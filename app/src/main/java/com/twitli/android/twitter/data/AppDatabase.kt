...
@Database(entities = [MySettings::class, Content::class, User::class, Tweet::class, Noun::class, Verb::class, Adjective::class, Adverb::class, WordString::class], version = 3, exportSchema = false)
