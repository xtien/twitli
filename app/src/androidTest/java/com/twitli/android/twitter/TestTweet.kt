...
class TestTweet {
    ...
    fun showWindow() {
        ...
        Espresso.onView(withId(R.id.tweet_button)).perform(ViewActions.click())
        Espresso.onView(withId(R.id.tweet)).check(ViewAssertions.matches(IsNot.not(ViewMatchers.isDisplayed())))
    }
    ...
    fun typeText() {
        ...
        Espresso.onView(withId(R.id.tweet_button)).perform(ViewActions.click())
        Espresso.onView(withId(R.id.tweet)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        Espresso.onView(withId(R.id.status_tweet_text)).perform(ViewActions.replaceText("test text"))
        Espresso.onView(withId(R.id.status_tweet_text)).check(ViewAssertions.matches(ViewMatchers.withText("test text")))
    }
}
